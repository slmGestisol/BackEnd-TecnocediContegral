...
namespace com.ServiBarras.WebAPI.Controllers.Despacho
{
    ...
    public class DespachoController : ControllerBase
    {
        ...
        [Route("api/getCheckFaltanteDespachos/")]
        [HttpPost]
        public JsonResult getCheckFaltanteDespachos([FromBody] JObject parametrosCheckFaltanteDespachos)
        {

            DataSet result = new DataSet();
            result = this._despachoBL.getCheckFaltanteDespachos(parametrosCheckFaltanteDespachos);
            if (result == null)
            {
                result = new DataSet();

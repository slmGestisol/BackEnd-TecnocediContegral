...
{   
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        {
            var result = this._usuarioBL.getRoles();
            if (result == null)
            {
                result = new DataSet();
                DataTable dt = new DataTable("table");
        ...
        // POST: api/setActualizacionCreacionUsuario
        [Route("api/setActualizacionCreacionUsuario/")]
        [HttpPost]
        public JsonResult setActualizacionCreacionUsuario([FromBody] JObject parametrosUsuario)
        {
            var result = this._usuarioBL.setActualizacionCreacionUsuario(parametrosUsuario);
            if (result == null)
            {
                result = new DataSet();
                DataTable dt = new DataTable("table");
